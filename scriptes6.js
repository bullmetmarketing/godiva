...
const mainIe = () => {
  ...
  const view = new function() {
    this.addIeTemplate = () => {
      ...
      this.toggleIeClasses(selectors.brSwiperContainer, 'godiva-swiper-container',);
      this.toggleIeClasses(selectors.brSwiperWrapper, 'godiva-swiper-wrapper', );
      this.toggleIeClasses(selectors.brSwiperDefault, 'default' );
      this.toggleIeClasses(selectors.brHistoryImgContainer, 'godiva-history-se-ctnt-block-img-container');
      this.toggleIeClasses(selectors.brHistoryImg, 'godiva-history-se-ctnt-block-img');
      this.toggleIeClasses(selectors.brHistoryTextContainer, 'godiva-history-se-ctnt-block-text');    
      this.toggleIeClasses(selectors.brHistoryBlock, 'godiva-history-se-ctnt-block');
      this.addProductCTA();
    }
