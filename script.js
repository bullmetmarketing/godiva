...
var main = function main() {
  var selectors = new function () {
    ...
    this.brSwiper = this.page.querySelector('.godiva-swiper');
    this.brSwiperContainer = this.brSwiper.querySelector('.godiva-swiper-container');
    ...
    this.brSwiperWrapper = this.brSwiperContainer.querySelector('.godiva-swiper-wrapper');
    this.brSwiperProductInfo = this.brSwiperContainer.querySelector('.godiva-swipe-product-info-title');
    this.brSwiperProductPrize = this.brSwiperContainer.querySelector('.godiva-swipe-product-info-prize');
    this.brSwiperProductCTA = this.brSwiperContainer.querySelector('.godiva-swipe-product-info a');
    this.brSwiperProductCounter = this.brSwiperContainer.querySelector('.godiva-swipper-product-counter');
    this.brSwiperFocus;
    this.brSwiperNext;
    this.brSwiperPrev;
  }();
  ...
  var view = new function () {
    ...
    this.setStartingPosition = function () {
      ...
      selectors.brSwiperWrapper.style.left = "".concat(model.productWidth * swiperPosition - model.productWidth / 2, "px");
...
var mainIe = function mainIe() {
  var selectors = new function () {
    this.page = document.querySelector('body');
    this.brSwiperContainer = this.page.querySelectorAll('.godiva-swiper-container');
    this.brSwiperWrapper = this.page.querySelectorAll('.godiva-swiper-wrapper');
    this.brSwiperDefault = this.page.querySelectorAll('.default');
    this.brHistoryImgContainer = this.page.querySelectorAll('.godiva-history-se-ctnt-block-img-container');
    this.brHistoryImg = this.page.querySelectorAll('.godiva-history-se-ctnt-block-img');
    this.brHistoryTextContainer = this.page.querySelectorAll('.godiva-history-se-ctnt-block-text');
    this.brHistoryBlock = this.page.querySelectorAll('.godiva-history-se-ctnt-block');
    this.brSwiperProductInfo = this.page.querySelector('.godiva-swipe-product-info');
  ...
  var view = new function () {
    ...
    this.addIeTemplate = function () {
      ...
      _this3.toggleIeClasses(selectors.brSwiperContainer, 'godiva-swiper-container');

      _this3.toggleIeClasses(selectors.brSwiperWrapper, 'godiva-swiper-wrapper');

      _this3.toggleIeClasses(selectors.brSwiperDefault, 'default');

      _this3.toggleIeClasses(selectors.brHistoryImgContainer, 'godiva-history-se-ctnt-block-img-container');

      _this3.toggleIeClasses(selectors.brHistoryImg, 'godiva-history-se-ctnt-block-img');

      _this3.toggleIeClasses(selectors.brHistoryTextContainer, 'godiva-history-se-ctnt-block-text');

      _this3.toggleIeClasses(selectors.brHistoryBlock, 'godiva-history-se-ctnt-block');
    ...
    this.addProductCTA = function () {
      ...
      productListToArray.forEach(function (product) {
        ...
        pPrize.classList.add('godiva-swipe-product-info-prize-ie');
...
var mainNoSwiper = function mainNoSwiper() {
  ...
  var view = new function () {
    ...
    this.addIeTemplate = function () {
      ...
      _this4.toggleIeClasses(selectors.brSwiperContainer, 'godiva-swiper-container');

      _this4.toggleIeClasses(selectors.brSwiperWrapper, 'godiva-swiper-wrapper');
